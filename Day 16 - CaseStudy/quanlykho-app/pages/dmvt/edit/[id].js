        ...
        <Layout>
                ...
                <div className="form-group col-sm-7">
                    ...
                    <div className="form-control" id="formGroupItemInput">
                        <input className="form-check-input" type="radio" name="status" id="inlineRadio1" value="1" defaultChecked onChange={handleChange}/>
                ...
                <div className="form-group col-sm-7">
                    ...
                    <select name="loai_vt" className="form-control" id="formGroupItemInput" value={item.loai_vt} onChange={handleChange} required>
                {
                                itemType.map((itemType, index) => (
                                    <option key={index} value={itemType.ma_loai}>{itemType.ten_loai}</option>
                                ))
                            }  
                </select>
                </div><br/>
                        <img alt="not fount" width={"250px"} src={item.image || ''} /><br />
                        <div className="form-group col-sm-7">
